                    ...
                    <!-- Logo -->
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('coordinator') }}">
                                <img class="block h-16 w-auto lg:hidden" src="https://fk.ump.edu.my/images/logo-faculty/logo-fk_new-ump.svg" alt="UMP">
                                <img class="hidden h-16 w-auto lg:block" src="https://fk.ump.edu.my/images/logo-faculty/logo-fk_new-ump.svg" alt="UMP">
                            </a>
                        </div>

                    <!-- Navigation Links -->
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{ route('coordinator') }}" :active="request()->routeIs('coordinator')">
                                {{ __('Dashboard') }}
                            </x-jet-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
