                ...
                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    <table class="table table-hover table-success table-striped" width="100%">
                        ...
                        <tr>
                            ...
                            <td><a href="rubricdata/{{$rubric->Rubric_id}}/edit" class="btn btn-success">Update</a></td>
                            <td><a href="rubricdata/{{$rubric->Rubric_id}}/delete" class="btn btn-danger" onClick = "return confirm('Are you sure you want to delete this data?')">Delete</a></td>
                    </tr> 
                    @endforeach 
                    </table>
                </div><br>
