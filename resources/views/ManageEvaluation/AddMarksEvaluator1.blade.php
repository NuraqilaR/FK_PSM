        ...
        <div class="row">
            <div class="mx-auto" style="width: 1000px;">
                <div class="card " style="border:1px solid black">
                    <div class="card-header text-center" style="color: black"><h1>Add Evaluation Marks <br>(Evaluatee)</h1>
                    ...
                    <div class="card-body">
                        ...
                        <form action="createEva" method="post">
                        {!! csrf_field() !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><input type="text" class="form-control" name="TotalEva2" id="TotalEva2" ></td>
                                </tr>
                            </tbody>
                          </table>
                        </div>
